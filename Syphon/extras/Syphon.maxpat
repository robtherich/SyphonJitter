...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 700.0, 321.0, 59.0, 20.0 ],
					"text" : "appname"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 687.0, 291.0, 72.0, 20.0 ],
					"text" : "servername"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 342.5, 159.0, 59.0, 22.0 ],
									"text" : "appname"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 558.0, 146.5, 141.0, 47.0 ],
									"text" : "clear servername when binding via appname and vice versa"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 468.5, 159.0, 72.0, 22.0 ],
									"text" : "servername"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 439.0, 135.0, 48.5, 22.0 ],
									"text" : "t l b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 439.0, 106.181824000000006, 108.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 336.0, 254.181824000000006, 98.0, 22.0 ],
									"text" : "prepend append"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 236.0, 230.181824000000006, 219.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.166656494140625, 108.61431884765625, 237.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 173.5, 44.767578125, 362.0, 56.0 ],
					"text" : "Syphon Package"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 761.0, 321.0, 112.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 185.0, 114.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 507.0, 229.0, 273.0, 22.0 ],
					"text" : "jit.gl.syphonclient client @servername \"jit syphon\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 307.0, 283.0, 22.0 ],
					"text" : "jit.gl.syphonserver server @servername \"jit syphon\""
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 817.0, 315.0, 883.25, 315.0, 883.25, 242.0, 815.5, 242.0 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 817.0, 346.0, 887.75, 346.0, 887.75, 242.0, 860.5, 242.0 ],
					"source" : [ "obj-45", 1 ]
				}
...
, 			{
				...
				"patcherrelativepath" : "../../../max6-git/max/packages/Vizzie/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../../max6-git/max/packages/Vizzie/patchers/utils",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../max6-git/max/packages/Vizzie/code",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
